...
def sample_negatives_for_chromosome(
    ...
    if strategy == "gc_matched":
        ...
        print(f"Sampled {len(negatives)} / {total_needed} random unmatched negatives for {chrom} (attempts: {attempts}).")
                ...
                while fill_attempts < 1000:
                    ...
                    if not is_overlapping(start, end, pos_intervals):
                        ...
                        if 'N' not in seq:
                            ...
                            break
        print(f"Generated {len(negatives)} / {total_needed} flanking negatives for {chrom}.")
