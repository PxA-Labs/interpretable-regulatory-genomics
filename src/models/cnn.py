...
class ShallowCNN(nn.Module):
    ...
    """
    def __init__(self, sequence_length: int = 1000, n_filters_1: int = 64, 
                 n_filters_2: int = 128, kernel_size_1: int = 15, 
                 kernel_size_2: int = 9, pool_size: int = 4, 
                 dropout_rate: float = 0.3):
        super(ShallowCNN, self).__init__()
        
        # Conv Layer 1: capture TF motifs
        self.conv1 = nn.Conv1d(in_channels=4, out_channels=n_filters_1, 
                               kernel_size=kernel_size_1, padding=kernel_size_1 // 2)
        ...
        self.conv2 = nn.Conv1d(in_channels=n_filters_1, out_channels=n_filters_2, 
                               kernel_size=kernel_size_2, padding=kernel_size_2 // 2)
...
class AttentionCNN(nn.Module):
    ...
    """
    def __init__(self, sequence_length: int = 1000, n_heads: int = 4, dropout_rate: float = 0.3):
        ...
        self.attention = nn.MultiheadAttention(embed_dim=64, num_heads=n_heads, dropout=dropout_rate, batch_first=True)
